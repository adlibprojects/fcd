      ...
      <div id="main">
		...
		?>
         <div id="product_slides" class="float_left">
          <img src="images/collections_thumbnails/rings/product/bridal_7_round_brilliant_diamond_ring_withsmallerdiamonds2.jpg" />
          <img src="images/collections_thumbnails/rings/product/bridal_7_round_brilliant_diamond_ring_withsmallerdiamonds3.jpg" />
        </div>  
        ...
        <div class="main_text float_right">
        	 <?php include('includes/customize_btn.php'); ?>
              ...
              <div class="collections_info clear">
                ...
                <p class="border">Round Brilliant Diamond Engagement<br /> Ring with Smaller Diamonds<br /> Encircling Center Stone and Ring</p>
                <p>Starting at $500</p>

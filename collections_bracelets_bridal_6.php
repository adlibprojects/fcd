<?php 
	...
	$pageKeywords_str = "Pearls, Stacked Bracelet, South Sea Baroque Pearls, Diamond Detailed Clasp";
	$pageDescription_str = "South Sea Baroque Pearl Stacked Bracelets with Diamond Detailed Hidden Clasps";
...
<?php include_once('includes/header.php'); ?>     
      ...
      <div id="main">
        ...
        <div id="product_slides" class="float_left">
          <img src="images/collections_thumbnails/bracelets/product/bridal_6_multistackedpearls.jpg" />
          <img src="images/collections_thumbnails/bracelets/product/bridal_6_multistackedpearls2.jpg" />
       </div> 
        ...
        <div class="main_text float_right">
              ...
              <div class="collections_info clear">
                ...
                <p class="border">South Sea Baroque Pearl Stacked Bracelets with Diamond Detailed Hidden Clasps</p>

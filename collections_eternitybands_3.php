<?php 
	...
	$pageKeywords_str = "Cushion Cut Eternity Band, Eternity Band, Cushion Cut, Rings, Eternity";
	$pageDescription_str = "Cushion Cut Eternity Band";
...
<?php include_once('includes/header.php'); ?>    
      ...
      <div id="product_slides" class="float_left">
		 <img src="images/collections_thumbnails/eternitybands/product/3_cushioncut_eternitybands_1.jpg" />   
         <img src="images/collections_thumbnails/eternitybands/product/3_cushioncut_eternitybands_2.jpg" />      
      </div>               
        <div class="main_text float_right">
             <?php include('includes/customize_btn.php'); ?>

              <div class="collections_info clear">
              	<p class="product_name"> Cushion Cut Eternity Band</p>
                <p class="border">Cushion Cut Eternity Band</p>

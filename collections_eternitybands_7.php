...
<?php include_once('includes/header.php'); ?>    
      ...
      <div id="product_slides" class="float_left">
         <img src="images/collections_thumbnails/eternitybands/product/7_asscher_eternitybands_1.jpg"/>
         <img src="images/collections_thumbnails/eternitybands/product/7_asscher_eternitybands_2.jpg"/>
         <img src="images/collections_thumbnails/eternitybands/product/7_asscher_eternitybands_3.jpg"/>
     </div>               

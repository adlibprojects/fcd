<?php 
	...
	$pageKeywords_str = "Circle Pendant, Whitee Gold, Diamond";
	$pageDescription_str = "Diamond Circle Pendant Set in White Gold";
	$pageTitle_str = "Diamond Circle Pendant Necklace | Necklaces";
...
<?php include_once('includes/header.php'); ?>     
      ...
      <div id="main">
       ...
       <div id="product_slides" class="float_left">
          <img src="images/collections_thumbnails/necklaces/product/6_diamond_circle_pendant2.jpg" />
          <img src="images/collections_thumbnails/necklaces/product/6_diamond_circle_pendant.jpg" />
       </div> 
        ...
        <div class="main_text float_right">
              ...
              <div class="collections_info clear">
              	<p class="product_name">Diamond Circle Pendant Necklace</p>
                <p class="border">Diamond Circle Pendant Set in White Gold</p>

<?php 
	...
	$pageKeywords_str = "Diamond Studded, white gold, Pendant, Pear Shape";
	$pageDescription_str = "Double Pear Shape Diamond Studded White Gold Pendant";
	$pageTitle_str = "White Gold Pendant Necklace | Necklaces";
...
<?php include_once('includes/header.php'); ?>
      ...
      <div id="main">
        ...
        <div id="product_slides" class="float_left">
         <img src="images/collections_thumbnails/necklaces/product/4_necklace_pearshaped_pendant.jpg" />
         <img src="images/collections_thumbnails/necklaces/product/4_necklace_pearshaped_pendant1.jpg" />
        </div> 
        ...
        <div class="main_text float_right">
              ...
              <div class="collections_info clear">
              	<p class="product_name">White Gold Pendant Necklace</p>
                <p class="border">Double Pear Shaped Diamond Studded White Gold Pendant</p>

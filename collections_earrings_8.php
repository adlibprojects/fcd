<?php 
	...
	$pageKeywords_str = "Tahitian Pearls, Diamond, White Gold, Half Bezel";
	$pageDescription_str = "Long Diamond Drop Earrings set in White Gold Half Bezel with Tahitian Pearls";
	$pageTitle_str = "Long Diamond Drop Earrings | Earrings";
...
<?php include_once('includes/header.php'); ?>    
      ...
      <div id="main">
       ...
       <div id="product_slides" class="float_left">
          <img src="images/collections_thumbnails/earrings/product/8_longdiamond_dropwithtahitianpearls2.jpg" />
          <img src="images/collections_thumbnails/earrings/product/8_longdiamond_dropwithtahitianpearls.jpg" />
       </div> 
        ...
        <div class="main_text float_right">
             <?php include('includes/customize_btn.php'); ?>
              ...
              <div class="collections_info clear">
              	<p class="product_name">Long Diamond Drop Earrings</p>
                <p class="border">Long Diamond Drop Earrings set in<br /> White Gold Half Bezel with Tahitian Pearls</p>

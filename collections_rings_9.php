...
<?php include_once('includes/header.php'); ?>  
      ...
      <div id="main">
        ...
        <div id="product_slides" class="float_left">
          <img src="images/collections_thumbnails/rings/product/9_diamond_sapphire.jpg" />
          <img src="images/collections_thumbnails/rings/product/9_diamond_sapphire1.jpg" />
          <img src="images/collections_thumbnails/rings/product/9_diamond_sapphire2.jpg" />
       </div>      
        ...
        <div class="main_text float_right">
        	 <?php include('includes/customize_btn.php'); ?>
              ...
              <div class="collections_info clear">
              	<p class="product_name">Sapphire Side Stone Ring</p>
                <p class="border">Oval Diamond with Sapphire Side Stones</p>

	...
	z-index:10;
      ...
      <div id="main">
        ...
        <div class="float_right main_text services">
              <p class="font_family_garamond font_size_medium_garamond">FCD provides invaluable guidance and assistance as clients decide if its worth resetting their existing stones or trading them in for something entirely new. Appraisals are done for all pieces, whether purchased from FCD or elsewhere.</p>
              <p></p>
     	...
     	<div id="slider1">
        	<img src="images/service_update_reset.jpg" width="575" height="520" />
            <img src="images/service_update_replace.jpg" width="575" height="520" />
            <img src="images/service_update_restore.jpg" width="575" height="520" />
        </div>  
